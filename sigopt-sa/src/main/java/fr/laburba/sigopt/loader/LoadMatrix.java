...
public class LoadMatrix {
	...
	public Graph loadGraph() {
		...
		// On instnancie les dépots et les centres de stockage et on les ajoute
		// à la liste de noeuds
		...
		// On ajoute les arcs à partir des identifiants en utilisant les
		// instances de dépôts et centre de stockage
