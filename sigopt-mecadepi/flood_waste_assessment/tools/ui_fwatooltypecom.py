...
class Ui_Fwatooltypecom_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(QtGui.QApplication.translate("Dialog", "Couche IRIS ou Bati", None, QtGui.QApplication.UnicodeUTF8))
        self.label2.setText(QtGui.QApplication.translate("Dialog", "Couche Commune", None, QtGui.QApplication.UnicodeUTF8))
