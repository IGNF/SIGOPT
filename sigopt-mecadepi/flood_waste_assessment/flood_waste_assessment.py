...
#--------------------------------------------------------------------- Les outils ---------------------------------------------------------------------
  ...
  def calcultoolbuild(self):
        ...
        surfhabiris = [] #surfhabiris les lignes sont les memes que resIrisInon
        ...
        log2 = [] # vecteur logement correspondant au nombre de logements dans un iris
        ...
        while (fit1.nextFeature(feat)):  
            ...
            if surfsol <= 180 : 
                surfhab = surfsol
            numiris = 0 # Fait plus tard
            nb_log_ino = 0 # Fait plus tard
            nb_log_ino2 = 0 # Fait plus tard
            poly = geom.asPolygon()
        ...
        while (fit3.nextFeature(feat3)):
            ...
            numirislog = feat4.attributes()[int(indchamplogiris)] # champ iris de logement
            nblog = feat4.attributes()[int(indchamplognbr)] # champ nb logement
            log = log + [numirislog]
            log2 = log2 + [nblog]
            i2 = i2 + 1
        ...
        for i in range(len(resinon)):
            ...
            if surfsoldubat <= 180 :
                ...
                if numirisdubat != 0 :
                    ...
                    resiris[numligneresiris] = resiris[numligneresiris] + 1
                    resiris2[numligneresiris] = resiris2[numligneresiris] + 1
                if numirisdubat == 0 : #a retirer dans lavenir
                    print("hello_world")
            if surfsoldubat > 180 :
                numirisdubat = resbati[id][8]
                if numirisdubat != 0 :
